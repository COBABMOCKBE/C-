...
layout3.addWidget(btn_ok, alignment = Qt.AlignCenter)



layout_card = QVBoxLayout()
layout_card.addLayout(layout1, stretch=2)
layout_card.addLayout(layout2, stretch=8)
layout_card.addStretch(1)
layout_card.addLayout(layout3, stretch=1)
layout_card.addStretch(1)
